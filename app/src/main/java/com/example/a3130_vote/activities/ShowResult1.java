...
/**
 * The type Show result 1.
 */
public class ShowResult1 extends AppCompatActivity {
    ...
    private static final String TAG = "ShowResult1";//Print log to terminal rather than remote console
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            inputvalue = new ArrayAdapter<String>(ShowResult1.this, android.R.layout.simple_list_item_1,output);
    ...
    public void back(){
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ShowResult1.this, HomeActivity.class);
